    ...
    <div class="rs-breadcrumbs innerbg1">
        <div class="container">
            <div class="breadcrumbs-inner text-center">
                <h1 class="breadcrumbs-title white-color">Risk Management Consultancy </h1>
                <ul class="breadcrumbs-meta">
                    <li><a href="<?php echo HTTP_BASE; ?>">Home</a></li>
                    <li>Risk Management Consultancy </li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <div class="rs-faq inner pt-50 pb-50 md-pt-80 md-pb-80">
        <div class="container">
            <div class="consulting_services">
                <h3 class="text-left">Risk Management Consultancy </h3>

                <p style="text-align: justify;">
                    With the constantly evolving regulatory environment, it is essential for every business to keep the
                    compliances up to date. The focus of BTBS is to support your company in smoothly navigating the
                    regulatory compliance matters related to banking. The matters covered here include support for
                    overseas transactions compliance covering External commercial borrowing (ECB), Foreign direct
                    investments (FDI), Overseas Direct Investment (ODI), export and import transactions. We help
                    through liaising with Banks &amp; FIs with the necessary correspondence to resolve the matter and
                    finding solutions for ensuring transactions are compliant.</p>

                <p><br />Our key mission is to ensure your company can grow and expand business hassle free, with matters
                    related to compliance taken care.</p>
