...
<body>
    ...
    <div class="rs-breadcrumbs innerbg1">
        <div class="container">
            <div class="breadcrumbs-inner text-center">
                <h1 class="breadcrumbs-title white-color">Gallery </h1>
    ...
    <div class="rs-blog inner modify gray-bg pt-120 pb-90 md-pt-80 md-pb-50">
        <div class="container">
            <div class="rs-gallery inner pt-120 pb-90 md-pt-80 md-pb-50">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-4 col-md-6 mb-30">
                            <div class="gallery-wrap">
                                <img src="<?= HTTP_BASE ?>images/gallery/img_1.png" alt="">
                                <a class="image-popup fly" href="<?= HTTP_BASE ?>images/gallery/img_1.png"><i class="fa fa-plus"></i></a>
                                <h4 class="title">Personal Law</h4>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 mb-30">
                            <div class="gallery-wrap">
                                <img src="<?= HTTP_BASE ?>images/gallery/img_2.png" alt="">
                                <a class="image-popup fly" href="<?= HTTP_BASE ?>images/gallery/img_2.png"><i class="fa fa-plus"></i></a>
                                <h4 class="title">Capital Market</h4>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 mb-30">
                            <div class="gallery-wrap">
                                <img src="<?= HTTP_BASE ?>images/gallery/img_3.png" alt="">
                                <a class="image-popup fly" href="<?= HTTP_BASE ?>images/gallery/img_3.png"><i class="fa fa-plus"></i></a>
                                <h4 class="title">Business Law</h4>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 mb-30">
                            <div class="gallery-wrap">
                                <img src="<?= HTTP_BASE ?>images/gallery/img_4.png" alt="">
                                <a class="image-popup fly" href="<?= HTTP_BASE ?>images/gallery/img_4.png"><i class="fa fa-plus"></i></a>
                                <h4 class="title">Family Law</h4>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 mb-30">
                            <div class="gallery-wrap">
                                <img src="<?= HTTP_BASE ?>images/gallery/img_5.png" alt="">
                                <a class="image-popup fly" href="<?= HTTP_BASE ?>images/gallery/img_5.png"><i class="fa fa-plus"></i></a>
                                <h4 class="title">Property Law</h4>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 mb-30">
                            <div class="gallery-wrap">
                                <img src="<?= HTTP_BASE ?>images/gallery/img_6.png" alt="">
                                <a class="image-popup fly" href="<?= HTTP_BASE ?>images/gallery/img_6.png"><i class="fa fa-plus"></i></a>
                                <h4 class="title">International Law</h4>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 mb-30">
                            <div class="gallery-wrap">
                                <img src="<?= HTTP_BASE ?>images/gallery/img_7.png" alt="">
                                <a class="image-popup fly" href="<?= HTTP_BASE ?>images/gallery/img_7.png"><i class="fa fa-plus"></i></a>
                                <h4 class="title">Bankruptcy Law</h4>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 mb-30">
                            <div class="gallery-wrap">
                                <img src="<?= HTTP_BASE ?>images/gallery/img_8.png" alt="">
                                <a class="image-popup fly" href="<?= HTTP_BASE ?>images/gallery/img_8.png"><i class="fa fa-plus"></i></a>
                                <h4 class="title">Traffic Tikets Law</h4>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 mb-30">
                            <div class="gallery-wrap">
                                <img src="<?= HTTP_BASE ?>images/gallery/img_9.png" alt="">
                                <a class="image-popup fly" href="<?= HTTP_BASE ?>images/gallery/img_9.png"><i class="fa fa-plus"></i></a>
