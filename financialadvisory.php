...
<body>
    ...
    <div class="rs-breadcrumbs innerbg1">
        <div class="container">
            <div class="breadcrumbs-inner text-center">
                <h1 class="breadcrumbs-title white-color">Financial Advisory </h1>
    ...
    <!-- consulting services Section Start -->
    <div class="rs-faq inner pt-50 pb-50 md-pt-80 md-pb-80">
        <div class="container">
            <div class="consulting_services">
                <h3 class="text-left">Financial Advisory</h3>

                <p>There are new developments in the way businesses manage their finance to unlock value. We
                    support our customers by providing the below financial advisory services:</p>


                <ol type="i">
                    <li>
                        <p>
                            Financing and banking structure – We understand your existing banking and financing
                            structure and your needs as well as goals you wish to accomplish. Accordingly, we make
                            suitable recommendations for bank rationalisation, alternate financing options like PE,
                            SBLC or ECB as well as assessing and arranging structured credit facility.
                        </p>
                    </li>
                    <li>
                        <p>
                            Credit liaison services – We help you prepare the credit memo note to present your case
                            for availing credit from Banks &amp; FIs. We also liaise with the financial institutions on
                            behalf of our clients to arrange the desired financing.
                        </p>
                    </li>
                    <li>
                        <p>
                            Fx consultation – We help clients to develop hedging strategies for their overseas
                            transactions as well as help improve margins for the clients.
                        </p>
                    </li>
                </ol>
    ...
    <!-- practical uses cases Areas Start -->
    <div class="rs-our-practice style1 title-bg pt-50 pb-50 md-pt-72 md-pb-80">
        <div class="container Practicalarea_px">
            <div class="sec-title top-line text-center mb-49 xs-mb-31">
                <h2 class="title white-color mb-0">Practical Use Cases</h2>
            </div>
            <div class="row">
                <div class="col-lg-4 col-md-6 mb-10 px-2">
                    <div class="practical_use_inner">
                        <div class="icon_part_practical_use">
                            <img src="<?php echo HTTP_BASE; ?>images/Service_page/Risk_Return_Transparency.png" alt="">
                        </div>
                        <div class="content_part_practical_use">
                            <h4 class="title"><a href="#">Risk Return Transparency</a></h4>
                            <p>Native necessary compliance and regulatory matters realted to Banking and FEMA</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 mb-10 px-2">
                    <div class="practical_use_inner">
                        <div class="icon_part_practical_use">
                            <img src="<?php echo HTTP_BASE; ?>images/Service_page/Stress_Testing.png" alt="">
                        </div>
                        <div class="content_part_practical_use">
                            <h4 class="title"><a href="#">Risk Return Transparency</a></h4>
                            <p>Native necessary compliance and regulatory matters realted to Banking and FEMA</p>
                ...
                <div class="col-lg-4 col-md-6 mb-10 px-2">
                    <div class="practical_use_inner">
                        <div class="icon_part_practical_use">
                            <img src="<?php echo HTTP_BASE; ?>images/Service_page/Risk_Strategy.png" alt="">
                        </div>
                        <div class="content_part_practical_use">
                            <h4 class="title"><a href="#">Risk Return Transparency</a></h4>
                            <p>Native necessary compliance and regulatory matters realted to Banking and FEMA</p>
                ...
                <div class="col-lg-4 col-md-6 mb-10 px-2">
                    <div class="practical_use_inner">
                        <div class="icon_part_practical_use">
                            <img src="<?php echo HTTP_BASE; ?>images/Service_page/Cash_Flow_at_Risk.png" alt="">
                        </div>
                        <div class="content_part_practical_use">
                            <h4 class="title"><a href="#">Risk Return Transparency</a></h4>
                            <p>Native necessary compliance and regulatory matters realted to Banking and FEMA</p>
                ...
                <div class="col-lg-4 col-md-6 mb-10 px-2">
                    <div class="practical_use_inner">
                        <div class="icon_part_practical_use">
                            <img src="<?php echo HTTP_BASE; ?>images/Service_page/Compliance_Health_Check.png" alt="">
                        </div>
                        <div class="content_part_practical_use">
                            <h4 class="title"><a href="#">Risk Return Transparency</a></h4>
                            <p>Native necessary compliance and regulatory matters realted to Banking and FEMA</p>
                ...
                <div class="col-lg-4 col-md-6 mb-10 px-2">
                    <div class="practical_use_inner">
                        <div class="icon_part_practical_use">
                            <img src="<?php echo HTTP_BASE; ?>images/Service_page/Finance_Assessment.png" alt="">
                        </div>
                        <div class="content_part_practical_use">
                            <h4 class="title"><a href="#">Risk Return Transparency</a></h4>
                            <p>Native necessary compliance and regulatory matters realted to Banking and FEMA</p>
    ...
    <!-------who it's for area start-------->
    <div class="rs-faq inner pt-50 pb-50">
        <div class="container Practicalarea_px">
            <div class="head_text">
                <h3>Who it's for</h3>
                <h4>Any publicly traded or privately held organization:</h4>
            </div>
            ...
            <div class="text_part_two">
                <h4>What You Get</h4>
                <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Corrupti quaerat ipsam aliquam. Quaerat porro vel, nisi itaque placeat veniam nesciunt deserunt modi sunt quasi molestias ut quibusdam. Nemo numquam voluptates dignissimos quae amet veniam saepe itaque quis ea expedita architecto optio repudiandae minus veritatis aliquam natus</p>
                <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Corrupti quaerat ipsam aliquam. Quaerat porro vel, nisi itaque placeat veniam nesciunt deserunt modi sunt quasi molestias ut quibusdam. Nemo numquam voluptates dignissimos quae amet veniam saepe itaque quis ea expedita architecto optio repudiandae minus veritatis aliquam natus</p>
            </div>
    ...
    <!-------who it's for area end-------->

    <!------hiring risk managment area start here------>
    <div class="rs-faq inner pb-50">
        <div class="container Practicalarea_px">
            <div class="risk_management_head_div">
                <h4>Hiring Risk Management Consultants<br>through Lorem Ispum is simple</h4>
            </div>
            <div class="risk_management_img_div">
                <div class="arrow_one none">
                    <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="#525050" class="bi bi-arrow-right" viewBox="0 0 16 16">
                        <path fill-rule="evenodd" d="M1 8a.5.5 0 0 1 .5-.5h11.793l-3.147-3.146a.5.5 0 0 1 .708-.708l4 4a.5.5 0 0 1 0 .708l-4 4a.5.5 0 0 1-.708-.708L13.293 8.5H1.5A.5.5 0 0 1 1 8z" />
                    </svg>
                </div>
                <div class="arrow_two none">
                    <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="#525050" class="bi bi-arrow-right" viewBox="0 0 16 16">
                        <path fill-rule="evenodd" d="M1 8a.5.5 0 0 1 .5-.5h11.793l-3.147-3.146a.5.5 0 0 1 .708-.708l4 4a.5.5 0 0 1 0 .708l-4 4a.5.5 0 0 1-.708-.708L13.293 8.5H1.5A.5.5 0 0 1 1 8z" />
                    </svg>
                </div>
                <div class="img_div">
                    <img src="<?php echo HTTP_BASE; ?>images/Service_page/Speak_with_One.png" alt="">
                    <div class="num">
                        <p>1</p>
                    </div>
                    <h4>Speak with one<br> of Our Experts</h4>
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Iusto molestiae consequatur distinctio consequuntur libero repellendus aliquam minus exercitationem neque enim.</p>
                </div>

                <div class="img_div">
                    <img src="<?php echo HTTP_BASE; ?>images/Service_page/Choose_Your_Favorite_Candidate.png" alt="">
                    <div class="num">
                        <p>2</p>
                    </div>
                    <h4>Speak with one<br> of Our Experts</h4>
                ...
                <div class="img_div">
                    <img src="<?php echo HTTP_BASE; ?>images/Service_page/Start_Your_Project.png" alt="">
                    <div class="num">
                        <p>3</p>
                    </div>
                    <h4>Speak with one<br> of Our Experts</h4>
    ...
    <!------hiring risk managment area end here------>

    <!--------point description area start here------>
    <div class="rs-faq inner pb-50">
        <div class="container Practicalarea_px">
            <div class="description_head">
                <h3>Identification, Assessment, Analysis, and Prioritization</h3>
            </div>
            <div class="description_point">
                <h4>Current State/Gap Analysis</h4>
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Velit nostrum ipsum officiis repudiandae adipisci tenetur commodi deserunt eius dignissimos voluptatum quos, sunt voluptates accusamus nihil fugit veniam saepe ut eos minima autem, quibusdam nesciunt! Praesentium quae atque enim dolorem. Quibusdam, dolorem. Ut quas laboriosam cupiditate amet, reprehenderit et est repellendus.</p>
            </div>
            <div class="description_point">
                <h4>Current State/Gap Analysis</h4>
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Velit nostrum ipsum officiis repudiandae adipisci tenetur commodi deserunt eius dignissimos voluptatum quos, sunt voluptates accusamus nihil fugit veniam saepe ut eos minima autem, quibusdam nesciunt! Praesentium quae atque enim dolorem. Quibusdam, dolorem. Ut quas laboriosam cupiditate amet, reprehenderit et est repellendus.</p>
    ...
    <!--------point description area end here------>
